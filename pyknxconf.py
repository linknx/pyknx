...
def makeArgumentParser(description):
    ...
    parser.add_argument('-n', '--comm-name', dest='communicatorName', help='Name of the communicator. Used to prefix name of rules generated by this script and to name the ioport service as well. Default is "pyknxcommunicator"', default='pyknx')
